<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="qualificationPage.aspx.cs" Inherits="SinaQueryAppEntity.pages.qualificationPage" %>
        ...
        <fieldset>
            ...
            <div class="col-sm-7">
                <div class="form-group">
                    <asp:Label CssClass="col-sm-3 control-label" ID="lblTitleId" runat="server" Text="Qualification Title"></asp:Label>
                    <div class="col-sm-9">
