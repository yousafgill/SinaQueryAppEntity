<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="LoginPage.aspx.cs" Inherits="SinaQueryAppEntity.pages.LoginPage" %>
        ...
        <div class="col-sm-6">
            ...
            <div class="form-group">
                <div class="col-sm-5 col-sm-offset-7 ">
                    <asp:Button CssClass="btn btn-primary btn-block" ID="UserLogin" runat="server" Text="Log In" ForeColor="Black" OnClick="UserLogin_Click" />
